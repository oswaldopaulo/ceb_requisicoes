           ...
           <div class="card mb-4">
			<div class="row">
              ...
              <div class="col-sm-6">
                <div >
                  <div class="card-body">
                    <h2 class="card-title text-center">INSUMOS E FERRAMENTAS DA REQUISIÇÃO  </h2>
            ...
            <div class="table-responsive">
                    ...
                    <tr style="font-size: 12px">
                		<td> {{ $i->cod_item }}</td>
                   		...
                   		<td>{{ $i->lote }}</td>
                   		<td>{{ $i->inicio?date("d/m/Y H:m:s", strtotime($i->inicio)):'' }}</td>
                   		<td>{{ $i->fim?date("d/m/Y H:m:s", strtotime($i->fim)):'' }}</td>
